...
const Notice = () => {
  ...
  return (
    <div className="Notice w-[85%] mx-auto flex justify-center items-start flex-col my-10 p-7 text-white">
      <div className="relative flex justify-between items-center w-full">
        ...
        {(router.pathname === "/faculty" || router.pathname === "/admin") &&
          (open ? (
            ...
            <button
              className="absolute right-2 flex justify-center items-center border-2 border-red-500 px-3 py-2 rounded-lg text-red-500"
              onClick={openHandler}
            >
              Add Notice
              <span className="ml-2">
      ...
      {open && (
        <form className="mt-8 w-full">
          <div className="w-[40%] mt-2">
            <label htmlFor="title" className="text-2xl">Notice Title</label>
            <input
              type="text"
              id="title"
              className="bg-blue-50 py-2 px-4 w-full mt-1 rounded-lg text-black"
              value={data.title}
              onChange={(e) => setData({ ...data, title: e.target.value })}
            />
          </div>
          <div className="w-[40%] mt-4">
            <label htmlFor="title" className="text-2xl">Notice Description</label>
            <textarea
              id="title"
              cols="30"
              rows="4"
              className="bg-blue-50 py-2 px-4 w-full mt-1 resize-none rounded-lg text-black"
          ...
          <div className="w-[40%] mt-4 text-2xl">
            <label htmlFor="type">Type Of Notice</label>
            <select
              id="type"
              className="px-2 bg-blue-50 py-3 rounded-lg text-base w-[80%] accent-blue-700 mt-4 text-black"
              value={data.type}
