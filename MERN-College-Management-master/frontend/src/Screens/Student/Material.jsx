...
const Material = () => {
  ...
  return (
    <div className="Material w-[85%] mx-auto mt-10 flex justify-center items-start flex-col mb-10 p-4 text-white">
      ...
      <div className="mt-8 w-full flex justify-center items-center flex-col">
        <div className="flex justify-center items-center w-[40%] space-x-4">
          <select
            ...
            className="px-2 bg-blue-50 py-3 rounded-lg text-base accent-blue-700 text-black"
          >
          ...
          <button
            ...
            className="bg-blue-500 text-white py-3 px-4 text-2xl rounded-lg"
          >
            <HiOutlineSearch />
          </button>
        </div>
