...
const Marks = () => {
  ...
  useEffect(() => {
    ...
    axios
      .post(
        ...
        `https://vercel.com/nishant0207s-projects/school-management-project-mern/BZzLfrdg25dTwKKkFXnKuue3tsnf/api/marks/getMarks`,
  ...
  return (
    <div className="Marks w-[85%] mx-auto mt-10 flex justify-center items-start flex-col mb-10 p-4 text-white">
