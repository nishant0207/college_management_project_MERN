...
import "./CSS Folder/Material.css"
const Material = () => {
  ...
  return (
    <div className="Material w-[85%] mx-auto mt-10 flex justify-center items-start flex-col mb-10 p-5 text-white">
      ...
      <div className="w-full flex justify-evenly items-center mt-12">
        <div className="w-1/2 flex flex-col justify-center items-center">
          <div className="w-[80%] mt-2">
            <label htmlFor="title" className="text-2xl">Material Title</label>
            <input
              type="text"
              id="title"
          ...
          <div className="w-[80%] mt-2 text-2xl">
            ...
            <select
              ...
              className="px-2 bg-blue-50 py-3 rounded-sm text-base accent-blue-700 mt-1 w-full text-black"
            >
          ...
          {!selected.link && (
            <label
              htmlFor="upload"
              className="px-2 bg-blue-50 py-3 rounded-sm text-base w-[80%] mt-4 flex justify-center items-center cursor-pointer text-black"
            >
              Upload Material
              <span className="ml-2">
                <FiUpload />
          ...
          />
          <button
            className="border-2 border-blue-500 text-white mt-8 px-4 py-2 rounded-lg"
