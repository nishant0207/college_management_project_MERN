...
const Timetable = () => {
  ...
  return (
    <div className="Timetable w-[85%] mx-auto mt-10 flex justify-center items-start flex-col mb-10 px-5 py-5 text-white">
      ...
      <div className="w-full flex justify-evenly items-center mt-12">
        <div className="w-1/2 flex flex-col justify-center items-center text-black">
          <p className="mb-4 text-3xl font-medium text-white">Add Timetable</p>
          <select
            id="branch"
            className="px-2 bg-blue-50 py-3 rounded-lg text-base w-[80%] accent-blue-700 mt-4"
          ...
          {!addselected.link && (
            <label
              htmlFor="upload"
              className="px-2 bg-blue-50 py-3 rounded-lg text-base w-[80%] mt-4 flex justify-center items-center cursor-pointer"
            >
              Upload Timetable
              <span className="ml-2">
                <FiUpload />
