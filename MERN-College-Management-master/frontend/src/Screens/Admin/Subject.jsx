...
const Subjects = () => {
  ...
  return (
    <div className="Subject w-[85%] mx-auto mt-10 flex justify-center items-start flex-col mb-10">
      ...
      {selected === "add" && (
        <div className="flex flex-col justify-center items-center w-full mt-8">
          <div className="w-[40%] mb-4">
            <label htmlFor="code" className="leading-7 text-1xl">
              Enter Subject Code
            </label>
            <input
              type="number"
          ...
          <div className="w-[40%]">
            <label htmlFor="name" className="leading-7 text-1xl ">
              Enter Subject Name
            </label>
            <input
              type="name"
            ...
            {subject &&
              subject.map((item) => {
                return (
                  <li
                    key={item.code}
                    className="bg-blue-100 py-3 px-6 mb-3 flex justify-between items-center w-[70%] mx-auto my-5 rounded-lg"
                  >
                    <div>
                      {item.code} - {item.name}
                    </div>
