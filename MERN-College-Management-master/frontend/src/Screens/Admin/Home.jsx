        ...
        <>
          ...
          <div className="w-[100%] mx-auto mt-8 flex justify-center items-start flex-col container">
            <ul className="flex justify-evenly items-center gap-10 w-[90%] mx-auto">
              <li
                className={`text-center rounded-lg px-4 py-2 w-1/5 cursor-pointer ease-linear duration-300 hover:ease-linear hover:duration-300 hover:transition-all transition-all ${
                  selectedMenu === "Profile"
                    ? "border-b-2 pb-2 border-blue-500 bg-blue-100 rounded-sm"
                    : "bg-blue-500 text-white hover:bg-blue-600 border-b-2 border-blue-500 shadow-xl"
                }`}
